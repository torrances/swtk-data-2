package org.swtk.data.twitter.core.dto.canonical.adapter;

import com.trimc.blogger.commons.LogManager;

public final class CannonicalTweetAdapter {

	public static LogManager logger = new LogManager(CannonicalTweetAdapter.class);
